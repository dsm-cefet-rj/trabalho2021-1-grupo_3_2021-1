    ...
    return (
        <>
            ...
            <div className="mb-3">
                ...
                <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Adicione uma descrição"  name="desc" value={produto.desc} onChange={handleImputChange}></textarea>
            </div>
